...
echo "==> Icons PNG"
curl -fsSL 'https://stocksubmitter.com/assets/img/icons/android-chrome-192x192.png' -o 'app/assets/img/icons/android-chrome-192x192.png'
curl -fsSL 'https://stocksubmitter.com/assets/img/icons/android-chrome-256x256.png' -o 'app/assets/img/icons/android-chrome-256x256.png'
curl -fsSL 'https://stocksubmitter.com/assets/img/icons/android-chrome-512x512.png' -o 'app/assets/img/icons/android-chrome-512x512.png'
curl -fsSL 'https://stocksubmitter.com/assets/img/icons/apple-touch-icon.png' -o 'app/assets/img/icons/apple-touch-icon.png'
curl -fsSL 'https://stocksubmitter.com/assets/img/icons/favicon-16x16.png' -o 'app/assets/img/icons/favicon-16x16.png'
curl -fsSL 'https://stocksubmitter.com/assets/img/icons/favicon-32x32.png' -o 'app/assets/img/icons/favicon-32x32.png'
curl -fsSL 'https://stocksubmitter.com/assets/img/icons/mstile-150x150.png' -o 'app/assets/img/icons/mstile-150x150.png'
